...
\begin{center}
    ...
    \textit{A Thinker on the Mount Everest's Summit}\footnote{This figure refers to ``The Great Flood'' analogy of a flooded landscape of human cognitive capacities~\parencite{moravec1988mind,moravec1998will} -- when some cognitive tasks are performed better by machines than humans, the ``mountain''-analogy of this domain is shown as flooded -- arts and sciences were shown as highest peaks in this analogy. The waxing crescent moon signifies a dawn of the human intellectual domination (well this interpretation of the crescent moon makes sense in the Northern hemisphere, and thus on the altitude of Mount Everest).}
